...
class AddOnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create add_on" do
    assert_difference('AddOn.count') do
      post add_ons_url, params: { add_on: { author: @add_on.author, contact_email: @add_on.contact_email, description: @add_on.description, name: @add_on.name } }
    end
  ...
  test "should update add_on" do
    patch add_on_url(@add_on), params: { add_on: { author: @add_on.author, contact_email: @add_on.contact_email, description: @add_on.description, name: @add_on.name } }
