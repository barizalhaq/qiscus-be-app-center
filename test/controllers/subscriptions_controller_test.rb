...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { add_on_id: @subscription.add_on_id, app_id: @subscription.app_id } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { add_on_id: @subscription.add_on_id, app_id: @subscription.app_id } }
